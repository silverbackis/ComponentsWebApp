 ...
 */
final class Version20200721155411 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, roles TEXT NOT NULL, password_reset_confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, new_username VARCHAR(255) DEFAULT NULL, username_confirmation_token VARCHAR(255) DEFAULT NULL, password_last_updated TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE component_location (id VARCHAR(36) NOT NULL, content_id VARCHAR(36) DEFAULT NULL, component_id VARCHAR(36) DEFAULT NULL, sort INT DEFAULT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE content (id VARCHAR(36) NOT NULL, layout_id VARCHAR(36) DEFAULT NULL, parent_route_id VARCHAR(36) DEFAULT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modified TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, security_roles JSON DEFAULT NULL, type VARCHAR(255) NOT NULL, dynamic BOOLEAN DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, meta_description VARCHAR(255) DEFAULT NULL, parent_id VARCHAR(36) DEFAULT NULL, nested BOOLEAN DEFAULT \'false\', dynamic_page_class VARCHAR(255) DEFAULT NULL, sort INT DEFAULT NULL, valid_components JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE dynamic_content (id VARCHAR(36) NOT NULL, parent_route_id VARCHAR(36) DEFAULT NULL, layout_id VARCHAR(36) DEFAULT NULL, nested BOOLEAN DEFAULT \'false\' NOT NULL, published BOOLEAN DEFAULT NULL, published_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, sort INT DEFAULT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modified TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, title VARCHAR(255) NOT NULL, meta_description VARCHAR(255) DEFAULT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
